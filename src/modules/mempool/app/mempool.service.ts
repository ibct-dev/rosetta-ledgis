...
export class MempoolService {
    ...
    public async getAllMempoolTrx(
        args: NetworkRequestDto
    ): Promise<MempoolResponseDto> {
        try {
            const result = await this._queryBus.execute(
                new GetAllMempoolTrxQuery(args)
            );
            return result;
        } catch (error) {
            throw error;
    ...
    public async getMempoolTrx(
        args: MempoolTransactionRequestDto
    ): Promise<MempoolTransactionResponseDto> {
        try {
            const result = await this._queryBus.execute(
                new GetMempoolTrxQuery(args)
            );
            return result;
        } catch (error) {
            throw error;
